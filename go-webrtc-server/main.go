...
func handleOffer(w http.ResponseWriter, r *http.Request) {
	...
	//go startSonicPi()
	// NOTE sonic pi jakc outputs will not be connected to webrtc stuff yet, we'll need to do that manually when starting sonic pi patch
...
func startSonicPi() {
	cmd := exec.Command("/usr/lib/sonic-pi/app/server/ruby/bin/sonic-pi-server.rb")
